...
public:
    ...
    virtual bool setDisplayCalibration(const std::vector<Calibration>&) = 0;
    virtual bool setRgbCalibration(const std::vector<Calibration>&) = 0;
    virtual bool setTofCalibration(const std::vector<Calibration>&) = 0;
    virtual bool getFisheyeCalibration(std::vector<Calibration>&, double& imuFisheyeTimestampOffset) = 0;
    virtual bool setFisheyeCalibration(const std::vector<Calibration>&, double imuFisheyeTimestampOffset) = 0;
...
public:
     ...
     */
    explicit AprilTagDetector(std::vector<xv::Calibration> const& c, std::string const& f="36h11", bool subpixelic=false);
